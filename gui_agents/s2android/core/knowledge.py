...
class KnowledgeBase(BaseModule):
    def __init__(
        ...
        platform_dir = os.path.join(self.local_kb_path, platform)
    ...
    def _initialize_empty_files(self):
        """Initialize empty files to prevent FileNotFoundError"""
        files_to_create = [
            os.path.join(self.local_kb_path, self.platform, "formulate_query.json"),
            os.path.join(self.local_kb_path, self.platform, "episodic_memory.json"),
            os.path.join(self.local_kb_path, self.platform, "narrative_memory.json"),
            os.path.join(self.local_kb_path, self.platform, "llm_rag_knowledge.json"),
            os.path.join(self.local_kb_path, self.platform, "perplexica_rag_knowledge.json"),
        ]
